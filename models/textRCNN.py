...
class TextRCNN(object):
    def __init__(self, W_list, num_classes=6, embedding_size=200, hidden_size=300):
        ...
        # conv1d layer
        outputs= tf.nn.conv1d(inputs, 96,kernel_size=3, padding='VALID')
